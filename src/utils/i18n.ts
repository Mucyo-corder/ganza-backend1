...
export const TERMS = {
  ...
  dashboard: { rw: 'Ahabanza', en: 'Dashboard', fr: 'Tableau de bord' },
  ...
  cancel: { rw: 'Reka', en: 'Cancel', fr: 'Annuler' },
  ...
  liveCamera: { rw: 'Kamera', en: 'Live Camera', fr: 'Caméra en direct' },
  loading: { rw: 'Tegereza gato', en: 'Loading', fr: 'Chargement' },
